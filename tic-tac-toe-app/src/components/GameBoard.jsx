    ...
    return (
        <div className='game-board'>
            {winner ? winner === "draw" ? (
                ...
                <p className='winner-title'>Player <span className={winner}>{winner}</span> wins!</p>
            ) : <p className={`winner-title`}>Current Player: <span className={currentPlayer}>{currentPlayer}</span></p>}
            <div className="board">
